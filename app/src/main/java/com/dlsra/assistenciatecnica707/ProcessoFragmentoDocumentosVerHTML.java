...
public class ProcessoFragmentoDocumentosVerHTML extends Activity {
    //valores passados
    private int _n_obra;
    ...
    private ProcessoFragmentoDocumentosVerHTMLAdaptador adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.processo_fragmento_documentos_ver_html);
        //pedir para retirar o titulo da aplicação
        ...
        try {
            ...
            if(null != conteudo) {
                adapter = new ProcessoFragmentoDocumentosVerHTMLAdaptador(ProcessoFragmentoDocumentosVerHTML.this, conteudo);
