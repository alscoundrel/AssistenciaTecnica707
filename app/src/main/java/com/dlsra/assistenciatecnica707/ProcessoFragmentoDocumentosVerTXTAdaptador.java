...
public class ProcessoFragmentoDocumentosVerTXTAdaptador extends PagerAdapter {
    ...
    // constructor
    public ProcessoFragmentoDocumentosVerTXTAdaptador(Activity activity, String conteudo) {
